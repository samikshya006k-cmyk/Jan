...
(function() {
    // 1. Inject Styles for JanSetu AI Chatbot
    ...
    // 2. Inject HTML for Floating AI Button & Chat Window
    ...
    window.JanSetuAIChatbot = {
        ...
        speakLastBotMsg(button) {
            ...
            // Extract text excluding buttons
        ...
        async processAIResponse(userText) {
            ...
            setTimeout(async () => {
                ...
                // 2. WARD OFFICERS & COUNCILLOR INQUIRY
                ...
                // 5. AUTO-TRIAGE & REPORT REGISTRATION
                    ...
                    // Trigger Gamification Karma Gain if function exists
    ...
    // Export legacy alias for full backwards compatibility
